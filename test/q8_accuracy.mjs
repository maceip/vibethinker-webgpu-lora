...
import { QwenModel, QWEN25_3B } from '../src/qwen25.js';
import { loadModelWeights } from '../src/weights.js';
import { quantizeInt8RowMajor, quantError } from '../src/qwgpu/quantize.js';

await tf.setBackend('cpu'); await tf.ready();
const MD = fileURLToPath(new URL('../model', import.meta.url)); const fds = {};
